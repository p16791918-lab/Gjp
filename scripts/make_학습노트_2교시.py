...
SECTIONS = [
    ('Ⅰ. 에너지대사 — 매년 다수 출제', [
        {
            'title': '에너지 대사 전체 흐름 — 해당 · TCA · 전자전달계', 'stars': '★★★ 개괄(전 문항의 뼈대)',
            'core': [
                '포도당 1개의 완전 산화는 <b>①해당(세포질) → ②피루브산 산화(미토콘드리아) → ③TCA 회로 → '
                '④전자전달계·산화적 인산화</b>의 네 단계로 이어진다.',
                '<b>①해당</b>: 포도당(6C)을 피루브산(3C) 2개로 쪼개며 직접 <b>ATP 2·NADH 2</b>를 얻는다(산소 불필요).',
                '<b>②피루브산 산화</b>: 피루브산이 미토콘드리아로 들어가 피루브산 탈수소효소로 아세틸CoA가 되며 회당 '
                '<b>NADH 1·CO₂ 1</b>(피루브산 2개면 ×2)을 낸다 — 이 단계는 비가역이라 포도당으로 되돌아갈 수 없다.',
                '<b>③TCA</b>: 아세틸CoA 1개당 <b>NADH 3·FADH₂ 1·GTP 1·CO₂ 2</b>(아세틸CoA 2개면 ×2). 여기서 나온 '
                'CO₂가 우리가 내쉬는 이산화탄소다.',
                '<b>④전자전달계</b>: 앞 단계가 모은 NADH·FADH₂의 전자를 산소로 넘기며 만든 양성자 기울기로 ATP를 '
                '대량 합성한다. 최신 계산으로 <b>NADH ≈ 2.5 ATP, FADH₂ ≈ 1.5 ATP</b>, 최종 전자수용체는 산소(→물).',
                '합치면 포도당 1개당 <b>약 30~32 ATP</b>이며, 산소가 없으면 ③④가 막혀 피루브산이 젖산이 되고 '
                'ATP는 해당의 2개뿐이다.'],
            'table': {'header': ['단계', '장소', '직접 산출'],
                      'rows': [
                          ['해당', '세포질', 'ATP 2 · NADH 2'],
                          ['피루브산 산화(×2)', '미토콘드리아 기질', 'NADH 2 · CO₂ 2'],
                          ['TCA(×2)', '미토콘드리아 기질', 'NADH 6 · FADH₂ 2 · GTP 2 · CO₂ 4'],
                          ['전자전달계', '미토콘드리아 속막', 'NADH·FADH₂ → 대부분의 ATP'],
                          ['총합', '', '≈ 30~32 ATP']]},
            'img': ('diagrams/energy_overview.png', '▲ 포도당 완전산화 전체 흐름과 ATP 총계'),
            'trap': '⚠ 함정 — 전자전달계 없이 해당만으로 30 ATP가 나온다고 낚는다(무산소는 2 ATP). NADH를 3·FADH₂를 '
                    '2 ATP로 계산하면(옛 값) 총계가 36~38로 달라지니 문항의 기준을 확인한다.'},
        {
    ...
    ('Ⅱ. 산화스트레스 · 산소운반', [
                    ...
                    'NADPH다.'},
        {
            ...
            'core': [
                ...
                '해리곡선을 <b>오른쪽으로</b>(친화도↓·조직에 산소 방출↑) 미는 요인은 <b>H+↑(pH↓)·CO₂↑·온도↑·'
                '2,3-BPG↑</b>이고(운동·발열하는 조직), <b>왼쪽으로</b>(친화도↑) 미는 요인은 그 반대와 '
                '<b>일산화탄소·태아헤모글로빈·미오글로빈</b>이다 — 이 pH·CO₂ 효과를 <b>보어(Bohr) 효과</b>라 한다.',
                '조직에서 나온 CO₂·H+가 우측이동을 일으켜 산소를 더 내주고, 폐에서는 반대로 좌측이동해 산소를 잘 '
                '싣는 것이 몸의 산소 배분 원리다.'],
            'table': {'header': ['이동', '방향·의미', '요인'],
                      'rows': [
                          ['우측이동', '친화도↓ · 조직에 O₂ 방출↑', 'pH↓·CO₂↑·온도↑·2,3-BPG↑'],
                          ['좌측이동', '친화도↑ · O₂ 방출↓', 'pH↑·CO₂↓·온도↓·CO·태아Hb'],
                          ['협조성', '헤모글로빈만(S자)', '미오글로빈은 없음(쌍곡선)']]},
            'img': ('diagrams/o2_dissociation.png', '▲ 산소해리곡선 — 보어 효과(pH·CO₂·온도·2,3-BPG)'),
            'trap': '⚠ 함정 — 2,3-BPG·산성·고온을 "좌측이동·친화도 증가"로 낚는다(실제는 우측이동·친화도 감소). '
                    '일산화탄소·태아헤모글로빈은 좌측이동(친화도↑)이다.'},
    ]),
    ('Ⅲ. 아미노산 · 질소대사', [
        {
    ...
    ('Ⅵ. 임상표지자 · 효소 · 신호', [
        ...
        {
            'title': '효소 동역학(Vmax·Km) · 억제(경쟁적 vs 비경쟁적)', 'stars': '★★★ 3년(22·23·25)',
            'core': [
                '미카엘리스-멘텐 식 <b>v = Vmax·[S] / (Km + [S])</b>에서, <b>Vmax</b>는 효소가 기질로 완전히 '
                '포화됐을 때의 최대 반응속도(효소 농도에 비례)이고, <b>Km</b>은 반응속도가 Vmax의 <b>절반</b>이 되는 '
                '기질 농도다.',
                'Km은 효소-기질 <b>친화도의 역지표</b>다 — Km이 작을수록 낮은 기질 농도에서도 반쯤 돌아가니 친화도가 '
                '높다.',
                '경쟁적 억제제는 활성부위를 두고 기질과 경쟁하므로 <b>Km은 커지고(친화도↓) Vmax는 그대로</b>이며, '
                '기질 농도를 높이면 극복된다.',
                '비경쟁적 억제제는 다른 부위에 결합해 <b>Vmax를 낮추고 Km은 그대로</b>이며 기질로 극복되지 않는다.'],
