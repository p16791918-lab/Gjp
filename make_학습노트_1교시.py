...
def header_widths(n):
    ...
    if n == 4: return [0.19, 0.27, 0.27, 0.27]
    return [1.0 / n] * n
    ...
    ('Ⅳ. 말초신경 · 근골격', [
        {
            ...
            'core': [
                '증상·손상부위로 세 신경을 반드시 감별. 그림·병력으로 "어느 신경"을 고름.'],
            'table': {'header': ['신경', '손상 부위', '증상'],
                      'rows': [
                          ['자신경', '팔꿉 안쪽위관절융기·기욤관', '갈퀴손, 새끼두덩·안쪽1.5손가락 저림'],
                          ['정중신경', '손목굴(carpal tunnel)', '원숭이손, 엄지두덩 위축, 가쪽3.5손가락'],
                          ['노신경', '위팔뼈 몸통(노신경고랑)', '손목처짐(wrist drop), 손등 감각']]},
            'trap': '⚠ 함정: 엄지두덩 위축=정중신경 / 새끼두덩·갈퀴손=자신경. 손목처짐은 노신경(자신경 아님).'},
        {
